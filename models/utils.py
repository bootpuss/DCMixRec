...
def data_consistency(k, k0, mask, noise_lvl=None):
    ...
    # print('\033[1;31m---utils.py---\033[0m')
    # print("k.shape = ", k.shape)
    # print("k0.shape = ", k0.shape)
    # print("mask.shape = ", mask.shape)
    # k.shape =  torch.Size([1, 256, 256, 2])
    # k0.shape =  torch.Size([1, 256, 256, 2])
    # mask.shape =  torch.Size([1, 1, 256, 512])
...
def fft2(data):
    ...
    # print(data.shape)
    x_k = torch.fft.fft2(data,dim=(-2,-1))
        # print(x_k.shape)
    x_k1 = torch.stack((x_k.real, x_k.imag), dim=-1)
    # print(x_k1.shape)
    data = fftshift(x_k1, dim=(-3, -2))
    # print(data.shape)
...
def ifft2(data):
    ...
    assert data.size(-1) == 2
    data = torch.complex(data[...,0], data[...,1])
    data = torch.fft.ifft2(data, dim=(-2, -1))
